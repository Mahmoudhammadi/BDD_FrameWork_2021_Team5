...
//    public static List<Authentication.User> readUserProfileFromSqlTable()throws IOException, SQLException, ClassNotFoundException {
//        List<Authentication.User> list = new ArrayList<>();
...
//                user = new Authentication.User(name,id, dob);
//                list.add(user);
//
//            }
//            st.close();
...
//        List<Authentication.User> list = readUserProfileFromSqlTable();
